...
import static com.cydeo.StaticConstants.*;
...
public class DataGenerator {
    ...
    public static void createProduct(){
        Product product1 = new Product(UUID.randomUUID(),"PS5",230.50,250.63,7,7,CATEGORY_LIST.get(0).getId());
        Product product2 = new Product(UUID.randomUUID(),"XBOX",120.50,180.63,15,15,CATEGORY_LIST.get(0).getId());
        Product product3 = new Product(UUID.randomUUID(),"Chair",30.50,50.63,85,85,CATEGORY_LIST.get(1).getId());
        Product product4 = new Product(UUID.randomUUID(),"Face Creme",6.50,8.63,250,250,CATEGORY_LIST.get(2).getId());
